...
def identity_block_lite(input_tensor, kernel_size, filters, stage, block, rate=4):
    filters1, filters2, filters3 = filters
    if K.image_data_format() == 'channels_last':
        bn_axis = 3
    else:
    ...
    import my_models
    x = Conv2D(max(my_models.LEAST_ATOMS, int(filters2/rate)), kernel_size,
...
def conv_block_lite(input_tensor, kernel_size, filters, stage, block, strides=(2, 2), rate=4):
    filters1, filters2, filters3 = filters
    if K.image_data_format() == 'channels_last':
        bn_axis = 3
    else:
    ...
    import my_models
    x = Conv2D(max(my_models.LEAST_ATOMS, int(filters2/rate)), kernel_size, padding='same',
...
def ResNet50_lite(include_top=True,
             input_tensor=None, input_shape=None,
             pooling=None,
             classes=1000,
                     rate=4):
    ...
    x = conv_block_lite(x, 3, [64, 64, 256], stage=2, block='a', strides=(1, 1), rate=rate)
    x = identity_block_lite(x, 3, [64, 64, 256], stage=2, block='b', rate=rate)
    x = identity_block_lite(x, 3, [64, 64, 256], stage=2, block='c', rate=rate)

    x = conv_block_lite(x, 3, [128, 128, 512], stage=3, block='a', rate=rate)
    x = identity_block_lite(x, 3, [128, 128, 512], stage=3, block='b', rate=rate)
    x = identity_block_lite(x, 3, [128, 128, 512], stage=3, block='c', rate=rate)
    x = identity_block_lite(x, 3, [128, 128, 512], stage=3, block='d', rate=rate)

    x = conv_block_lite(x, 3, [256, 256, 1024], stage=4, block='a', rate=rate)
    x = identity_block_lite(x, 3, [256, 256, 1024], stage=4, block='b', rate=rate)
    x = identity_block_lite(x, 3, [256, 256, 1024], stage=4, block='c', rate=rate)
    x = identity_block_lite(x, 3, [256, 256, 1024], stage=4, block='d', rate=rate)
    x = identity_block_lite(x, 3, [256, 256, 1024], stage=4, block='e', rate=rate)
    x = identity_block_lite(x, 3, [256, 256, 1024], stage=4, block='f', rate=rate)

    x = conv_block_lite(x, 3, [512, 512, 2048], stage=5, block='a', rate=rate)
    x = identity_block_lite(x, 3, [512, 512, 2048], stage=5, block='b', rate=rate)
    x = identity_block_lite(x, 3, [512, 512, 2048], stage=5, block='c', rate=rate)
